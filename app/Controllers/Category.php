...
class Category extends Admin_Controller 
{
	...
	*/
	public function fetchCategoryData()
	{
		...
		$data = $this->model_category->findAll();
	...
	*/
	public function create()
	{
		...
		$this->validation->setRule('category_name', 'Category name', 'trim|required');
        ...
        if ($this->validate($this->validation->getRules()) == TRUE) {
        	...
        	$create = $this->model_category->insert($data);
        	if($create == true) {
	...
	*/
	public function update($id)
	{
		...
		if($id) {
			$this->validation->setRule('edit_category_name', 'Category name', 'trim|required');
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($category_id) {
			$delete = $this->model_category->delete($category_id);
			if($delete == true) {
				$response['success'] = true;
