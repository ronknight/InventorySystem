...
class Stores extends Admin_Controller 
{
	...
	*/
	...
	{
		if($id) {
			$data = $this->model_stores->find($id);
	...
	*/
	public function fetchStoresData()
	{
		...
		$data = $this->model_stores->findAll();
    ...
    */
	public function create()
	{
		...
		$this->validation->setRule('store_name', 'Store name', 'trim|required');
        ...
        if ($this->validate($this->validation->getRules()) == TRUE) {
        	...
        	$create = $this->model_stores->insert($data);
        	if($create == true) {
    ...
    */
	public function update($id)
	{
		...
		if($id) {
			$this->validation->setRule('edit_store_name', 'Store name', 'trim|required');
    ...
    */
	public function remove()
	{
		...
		$response = array();
		if($store_id) {
			$delete = $this->model_stores->delete($store_id);
			if($delete == true) {
				$response['success'] = true;
