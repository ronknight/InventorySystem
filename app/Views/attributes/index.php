...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?=lang('Main.manage')?>
      <small><?=lang('Main.attributes')?></small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"><?=lang('Main.attributes')?></li>
    </ol>
  </section>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="active"><?=lang('Main.status')?></label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_active"><?=lang('Main.status')?></label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p><?=lang('Main.delConf')?></p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal"><?=lang('Main.close')?></button>
          <button type="submit" class="btn btn-primary"><?=lang('Main.yes')?></button>
        </div>
      </form>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    ...
    'order': [],
	'language': {
		'url': base_url + '/assets/bower_components/datatables.net/i18n/<?= $locale?>.json'
	}
  });
