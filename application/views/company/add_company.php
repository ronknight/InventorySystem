              ...
              <div class="row">
                <form role="form" class="form-horizontal">
                  <div class="form-group">
                    <div class="col-sm-6"><label>CUSTOMER NAME</label><input class="form-control" placeholder="Imran Shah" type="text" autofocus=""></div>
                    <div class="col-sm-6"><label>CUSTOMER CELL #</label><input class="form-control" placeholder="0333 1234567" type="text"></div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6"><label>CUSTOMER OLD NO</label><input class="form-control" placeholder="T-786" type="text"></div>
                    <div class="col-sm-6"><label>CUSTOMER ADDRESS</label><input class="form-control" placeholder="Charsadda" type="text"></div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6"><label>PICTURE</label><input class="form-control" placeholder="" type="file"></div>
                    <div class="col-sm-6"><label>JOIN DATE</label><input class="form-control" placeholder="26-10-2012" type="text"></div>
                  </div>
