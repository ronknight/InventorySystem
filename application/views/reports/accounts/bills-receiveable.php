                ...
                <div class="content-body">
                    ...
                    <div id="invoice-container" class="invoice-container">
                        ...
                        <div class="row-fluid center">
                            <strong>Bills Receivable</strong>
                        ...
                        <div class="invoice-table">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tr style="font-size: 16px; font-weight: bold;">
                                    ...
                                    <td colspan="2" class="right">44,660.00</td>
                                </tr>
                                <tr>
                                    <td>1st Mar, 2017 </td>
                                    <td class="center"><b><a href="accounts/journal_preview/23" target="_blank">1023</a></b></td>
                                    <td>Sumon</td>
                                    <td>Sales, </td>
                                ...
                                <tr>
                                    <td>2nd Mar, 2017 </td>
                                    <td class="center"><b><a href="accounts/journal_preview/30" target="_blank">1030</a></b></td>
                                    <td>shekh</td>
                                    <td>Cash, </td>
                                    <td class="right">0.00</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="5">Money Receipt</td>
                                </tr>
                                <tr>
                                    <td>2nd Mar, 2017 </td>
                                    <td class="center"><b><a href="accounts/journal_preview/32" target="_blank">1032</a></b></td>
                                    <td>Sumon</td>
                                    <td>Cash, </td>
                                    <td class="right">0.00</td>
                                ...
                                <tr>
                                    <td>2nd Mar, 2017 </td>
                                    <td class="center"><b><a href="accounts/journal_preview/34" target="_blank">1034</a></b></td>
                                    <td>Sumon</td>
                                    <td>Sales, </td>
                                    <td class="right">-13,930.00</td>
                                    <td class="right">0.00</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr style="font-size: 16px; font-weight: bold;">
                                    ...
                                    <td colspan="2" class="right">19,835.00</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
