            ...
            <div class="box-body">
                <div class="clearfix">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control input-medium" name="company_id" id="company_id">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body" id="rows-list">
                <div class="input-group">
                   ...
                   <select  id="trollSelect" class="js-example-basic-single js-states form-control" name="item_id"
                        ...
                        <?php foreach ($products as $rows) :
                            ...
                            ?>
                            <option id="<?= $rows_1->category_name; ?> <?= $rows->item_name; ?> <?= $rows->size; ?> <?= $rows->color; ?> " value="<?= $rows->item_id; ?>"><?= $rows_1->category_name; ?> <?= $rows->item_name; ?> <?= $rows->size; ?> <?= $rows->color; ?> #<?= $rows->article_no ?>
                            </option>
                        <?php endif;
                    endforeach;
                endforeach; ?>
